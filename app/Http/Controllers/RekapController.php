...
class RekapController extends Controller
{
    ...
    {
        $data = DB::table("users")
        ->select(DB::raw("SUM(gaji.total) as total, users.name, gaji.created_at, gaji.id, users.id AS id_pegawai, users.id_team, gaji_lembur.nama, gaji_lembur.gaji AS gaji_lembur, bank.atas_nama , bank.norek, bank.bank"))
        ->leftJoin('gaji', function($join){
            $join->on('gaji.user_id', '=', 'users.id');
        })
        ->leftJoin('gaji_lembur', function($join){
    ...
    public function view($id)
    {
     ...
     $data = DB::table("users")
     ->select(DB::raw("SUM(gaji.total) as total, users.name, gaji.created_at, gaji.id, gaji_lembur.gaji AS total_lembur, bank.atas_nama , bank.norek, bank.bank"))
     ->leftJoin('gaji', function($join){
        $join->on('gaji.user_id', '=', 'users.id');
    })
     ->leftJoin('gaji_lembur', function($join){
